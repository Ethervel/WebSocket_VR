...
|-----------|---------|------|
| Client Unity | `VRNetworkManager.cs` | Se connecte au serveur, envoie/reçoit messages |
| Serveur | `server.js` | Reçoit et redistribue les messages |
| Base de données | `db.js` | Stocke les utilisateurs |
